  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white border border-border rounded-xl p-6">
        ...
        <p className="text-xs text-muted mb-4">Your FOOTBALL WAGGA account — the account payments are sent from.</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="FOOTBALL WAGGA Pty Ltd"
