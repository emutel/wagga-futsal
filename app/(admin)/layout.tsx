    ...
    <div className="min-h-screen flex">
      ...
      <aside className="w-56 bg-navy text-white flex flex-col shrink-0">
        <div className="px-4 py-5 border-b border-white/10 flex items-center gap-3">
          <Image src="/logo.png" alt="FOOTBALL WAGGA WAGGA" width={36} height={36} className="rounded shrink-0" />
          <div>
            <p className="text-white font-black text-sm leading-tight">FOOTBALL WAGGA WAGGA</p>
