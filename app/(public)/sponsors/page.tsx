  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <p className="text-muted mb-10">
        FOOTBALL WAGGA WAGGA is proudly supported by these local businesses and organisations.
      </p>
      ...
      <div className="mt-12 bg-navy/5 rounded-2xl p-8 text-center">
        ...
        <p className="text-muted mb-4">
          Support FOOTBALL WAGGA WAGGA and get your brand in front of hundreds of local families every week.
        </p>
        <a
